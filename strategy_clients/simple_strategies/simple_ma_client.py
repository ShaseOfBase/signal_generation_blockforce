...
class SignalGeneratorSimpleMa(StrategyClient):
    ...
    MA LONG Only BTC 1H If 21h moving avg closes above 55h moving average buy, close position on a close below
    MA LONG Only ETH 1H If 21h moving avg closes above 55h moving average buy, close position on a close below
    MA SHORT Only BTC 1H If 21h moving avg closes below 55h moving average sell, close position on a close above
    MA SHORT Only ETH 1H If 21h moving avg closes below 55h moving average sell, close position on a close above
    """
